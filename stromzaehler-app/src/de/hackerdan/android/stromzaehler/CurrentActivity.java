...
public class CurrentActivity extends Activity
{
   ...
   protected void onResume()
   {
      ...
      ((ImageView) findViewById(R.id.imageCharge)).setImageResource(R.drawable.charge_off);
      ((ImageView) findViewById(R.id.imageWama)).setImageResource(R.drawable.wama_off);
